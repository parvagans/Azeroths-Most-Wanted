...
class MobileLayoutTests(unittest.TestCase):
    ...
    def test_mobile_css_covers_key_dashboard_routes(self):
        ...
        self.assertIn(".amw-leaderboard-list", mobile_css)
        self.assertIn(".amw-leaderboard-card", mobile_css)
        self.assertIn(".amw-leaderboard-rank", mobile_css)
        self.assertIn(".amw-leaderboard-avatar", mobile_css)
        self.assertIn("--leaderboard-card-columns: 46px minmax(0, 1fr) auto;", mobile_css)
        ...
        self.assertNotIn(".podium-block", mobile_css)
        self.assertNotIn(".amw-leaderboard-crown", mobile_css)
        ...
        self.assertIn(".char-card-commendation-showcase", mobile_css)
        self.assertIn(".char-card-commendation-showcase-grid", mobile_css)
        self.assertIn(".char-card-commendation-showcase-summary {\n    gap: 12px;\n    padding: 13px 14px;", mobile_css)
        self.assertIn(".char-card-commendation-showcase-summary-icon {\n    width: 40px;", mobile_css)
        self.assertIn(".char-card-commendation-showcase-body", mobile_css)
        self.assertIn(".char-card-commendation-showcase-history-line", mobile_css)
        self.assertIn(".char-card-commendation-showcase-history-line {\n    padding: 7px 9px;", mobile_css)
        self.assertIn(".char-card-commendation-showcase-item-reigning-static > .char-card-commendation-showcase-body {", mobile_css)
        self.assertIn(".char-card-commendation-showcase-item[open] > .char-card-commendation-showcase-body {", mobile_css)
        self.assertIn(".char-card-header-badges {\n    justify-content: flex-start;", mobile_css)
        self.assertIn(".char-card-header-badges .char-card-header-reigning-badge-primary {\n    margin-left: 0;", mobile_css)
        ...
        self.assertIn(".char-card-header-reigning-badge {\n    width: 100%;\n    cursor: default;", mobile_css)
        self.assertIn(".char-card-header-reigning-badge-icon {\n    width: 32px;", mobile_css)
